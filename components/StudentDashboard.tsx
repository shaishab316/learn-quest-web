      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-6 md:py-8">
        ...
        <header className="flex justify-between items-center mb-8 bg-white/5 backdrop-blur-md p-4 rounded-3xl border border-white/10 shadow-lg">
          <motion.div
            ...
            <div className="w-12 h-12 bg-gradient-to-br from-kingdom-blue to-blue-600 rounded-2xl flex items-center justify-center transform -rotate-6 border-2 border-white shadow-[0_0_15px_rgba(0,212,255,0.5)] group cursor-pointer hover:rotate-0 transition-transform">
              <Rocket
